...
//#include <move_robot/IMU_Encoder.h>
...
protected:
    ...
    ros::Publisher IMU_Encoder_Publisher_;
    ...
    ros::Publisher AGV_Pose_Publisher_;
    ros::Publisher AGV_Imu_Publisher_;
...
Move_Robot::Move_Robot(char *dev_name, int Baudrate)
{
    ...
    AGV_Pose_Publisher_ = node_.advertise<geometry_msgs::PoseStamped>("AGV_Pose", 10);
    AGV_Imu_Publisher_ = node_.advertise<sensor_msgs::Imu>("AGV_Imu", 10);
