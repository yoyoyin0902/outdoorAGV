...
"""autogenerated by genpy from JoyStick/Node_recv.msg. Do not edit."""
import codecs
import sys
...
class Node_recv(genpy.Message):
  _md5sum = "ea0b94b98c9f92d87ddfce4a90987d71"
  _type = "JoyStick/Node_recv"
...
float32 radius
"""
  __slots__ = ['check','value','kin','id','type','time','btn_finish','x','y','z','line','radius']
  _slot_types = ['int8','int8','string','int16','int16','int32','bool','float32','float32','float32','int8','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       check,value,kin,id,type,time,btn_finish,x,y,z,line,radius
