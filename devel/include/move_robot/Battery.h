// Generated by gencpp from file move_robot/Battery.msg
// DO NOT EDIT!


#ifndef MOVE_ROBOT_MESSAGE_BATTERY_H
#define MOVE_ROBOT_MESSAGE_BATTERY_H
...
struct Battery_
{
  ...
  typedef boost::shared_ptr< ::move_robot::Battery_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::move_robot::Battery_<ContainerAllocator> const> ConstPtr;

}; // struct Battery_

typedef ::move_robot::Battery_<std::allocator<void> > Battery;

typedef boost::shared_ptr< ::move_robot::Battery > BatteryPtr;
typedef boost::shared_ptr< ::move_robot::Battery const> BatteryConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::move_robot::Battery_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::move_robot::Battery_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::move_robot::Battery_<ContainerAllocator1> & lhs, const ::move_robot::Battery_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::move_robot::Battery_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::move_robot::Battery_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::move_robot::Battery_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::move_robot::Battery_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::move_robot::Battery_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::move_robot::Battery_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::move_robot::Battery_<ContainerAllocator> >
{
  ...
  static const char* value(const ::move_robot::Battery_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x49990e1b1b63370eULL;
  static const uint64_t static_value2 = 0xe64f7539c711f8c7ULL;
};

template<class ContainerAllocator>
struct DataType< ::move_robot::Battery_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::move_robot::Battery_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::move_robot::Battery_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::move_robot::Battery_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::move_robot::Battery_<ContainerAllocator>& v)
  {
    s << indent << "Voltage: ";
...
#endif // MOVE_ROBOT_MESSAGE_BATTERY_H
