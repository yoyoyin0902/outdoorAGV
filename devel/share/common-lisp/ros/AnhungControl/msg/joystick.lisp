...
(cl:defmethod cl:initialize-instance :after ((m <joystick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joystick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AnhungControl-msg:<joystick> is deprecated: use AnhungControl-msg:joystick instead.")))

(cl:ensure-generic-function 'btn_id-val :lambda-list '(m))
(cl:defmethod btn_id-val ((m <joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AnhungControl-msg:btn_id-val is deprecated.  Use AnhungControl-msg:btn_id instead.")
  (btn_id m))
