...
(cl:defmethod cl:initialize-instance :after ((m <Node_recv>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Node_recv)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name JoyStick-msg:<Node_recv> is deprecated: use JoyStick-msg:Node_recv instead.")))

(cl:ensure-generic-function 'check-val :lambda-list '(m))
(cl:defmethod check-val ((m <Node_recv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader JoyStick-msg:check-val is deprecated.  Use JoyStick-msg:check instead.")
  (check m))
...
(cl:defmethod kin-val ((m <Node_recv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader JoyStick-msg:kin-val is deprecated.  Use JoyStick-msg:kin instead.")
  (kin m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Node_recv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader JoyStick-msg:id-val is deprecated.  Use JoyStick-msg:id instead.")
  (id m))
...
(cl:defmethod btn_finish-val ((m <Node_recv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader JoyStick-msg:btn_finish-val is deprecated.  Use JoyStick-msg:btn_finish instead.")
  (btn_finish m))
...
(cl:defmethod line-val ((m <Node_recv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader JoyStick-msg:line-val is deprecated.  Use JoyStick-msg:line instead.")
  (line m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <Node_recv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader JoyStick-msg:radius-val is deprecated.  Use JoyStick-msg:radius instead.")
  (radius m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Node_recv>)))
  ...
  "ea0b94b98c9f92d87ddfce4a90987d71")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Node_recv)))
  "Returns md5sum for a message object of type 'Node_recv"
  "ea0b94b98c9f92d87ddfce4a90987d71")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Node_recv>)))
  ...
  (cl:format cl:nil "int8 check~%int8 value~%string kin~%int16 id~%int16 type~%int32 time~%bool btn_finish~%float32 x~%float32 y~%float32 z~%int8 line ~%float32 radius~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Node_recv)))
  "Returns full string definition for message of type 'Node_recv"
  (cl:format cl:nil "int8 check~%int8 value~%string kin~%int16 id~%int16 type~%int32 time~%bool btn_finish~%float32 x~%float32 y~%float32 z~%int8 line ~%float32 radius~%~%~%"))
