...
(cl:defmethod cl:initialize-instance :after ((m <state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name move_robot-msg:<state> is deprecated: use move_robot-msg:state instead.")))
...
(cl:defmethod state-val ((m <state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_robot-msg:state-val is deprecated.  Use move_robot-msg:state instead.")
  (state m))
